...
> **Это [руки]** — практический маршрут уровня. Теория (зачем Ingress вместо NodePort, как работает cert-manager) — в `CURRICULUM.md` → «Уровень 5.5». Легенда `[голова]`/`[руки]` — в START_HERE.md.
